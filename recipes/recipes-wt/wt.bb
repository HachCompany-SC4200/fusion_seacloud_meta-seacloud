...
SECTION = "libs" 
LICENSE = "GPLv2"
LIC_FILES_CHKSUM = "file://${S}/LICENSE;md5=6565235fddf41c29afe574c96e32358c"
PR = "r0" 

DEPENDS = "openssl boost"

# This git commit corresponds to the tag of the release wt 3.3.7
SRC_URI = "git://github.com/emweb/wt.git"
SRCREV = "17c37f2fa9b57b1e2a6e2f412162d3df0192d785"
S = "${WORKDIR}/git"
...
do_install (){
	arm-angstrom-linux-gnueabi-strip -S ${S}/../build/src/libwt.a
	arm-angstrom-linux-gnueabi-strip -S ${S}/../build/src/http/libwthttp.a
