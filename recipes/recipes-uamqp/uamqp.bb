...
EXTRA_OECMAKE = "-Dmemory_trace:BOOL=ON -Duse_condition:STRING=ON -Duse_wsio:BOOL=OFF -Dskip_unittests:BOOL=ON -Duse_openssl:BOOL=ON  -DBUILD_TESTING:BOOL=OFF -Duse_schannel:bool=OFF -Duse_wolfssl:bool=OFF -Duse_http:bool=OFF -Dskip_samples:BOOL=ON -DCMAKE_BUILD_TYPE:STRING=Debug"
